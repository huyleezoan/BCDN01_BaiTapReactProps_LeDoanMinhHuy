...
import ProductListShoe from './ProductListShoe'
...
export default class ShoeShop extends Component {
    ...
    changeInfoShoe = (newShoe) => {
        this.setState({
            productDetail: newShoe
        })
    }
    render() {
        return (
            <div className="container">
                <h1 style={{ color: "blue" }}>Shoe Shop</h1>
                <ProductListShoe arrShoe={this.productList} changeInfo={this.changeInfoShoe} />
